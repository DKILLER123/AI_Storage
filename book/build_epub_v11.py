#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 11 EPUB (V10 review corrections: full character-intro card parity — 69/69 — with first-appearance blocks added across ch1-125 and the four BTS cards moved ch107->ch101; ch137 phone-call + billboard + diversified news sources + Scooter voice-message block; ch138 SK managing-director phone-call; plus newly-tagged live calls in ch57/58/127) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_11.epub"
