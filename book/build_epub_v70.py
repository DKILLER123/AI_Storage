"""Build the Version 70 EPUB (style-block line-separation redesign across all list blocks; ch249 video call -> facetime block; ch250 Hyundai call -> phone-call block; ch78 corner-bracket cleanup) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/AI_Storage/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_70.epub"
