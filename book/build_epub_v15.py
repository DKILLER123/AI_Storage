#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 15 EPUB (chapters 143-144 added: the chaebol takeover week - OLED walls, Times Square, KOSPI Daddy; the bank gold buy, the knights-of-gold rehearsal, the Coinbase night, Spotify takeover, and the Four Seasons hallway war) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_15.epub"
