"""Build the Version 59 EPUB (chapters 229-230 added: a set-visit gimbap mission, one guard who never heard of Red Velvet, a photo with three people digitally purged, a gun-range training night that ran to 3 a.m., a blinking contest won by unsanctioned cuteness, four lunchboxes for three people, and one stealth selfie that both parties kept) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_59.epub"
