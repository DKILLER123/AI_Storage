"""Build the Version 60 EPUB (chapters 231-232 added: a nightclub massacre pre-run in a game engine, corny pickup lines accepted on delivery, one invisible ex who invades a marriage with a chorus hook, a Kobe farewell call billed by the song, a Holy Mother brochure soaking under a noodle bowl, and one dorm unified theory delivered mouth-full-of-bear-cookie) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_60.epub"
