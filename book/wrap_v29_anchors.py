...
FORMS = [
    ...
    ("Bae Joo-hyun",  "chr-irene",         "irene.jpg"),
    ...
    ("Kang Seul-gi",   "chr-seulgi",        "seulgi.jpg"),
    ("Son Seung-wan",  "chr-wendy",         "wendy.jpg"),
    ("Seulgi",         "chr-seulgi",        "seulgi.jpg"),
    ("Wendy",          "chr-wendy",         "wendy.jpg"),
    ("Joy",            "chr-joy",           "joy.jpg"),
    ("Park Soo-young", "chr-joy",           "joy.jpg"),
    ("Soo-young",      "chr-joy",           "joy.jpg"),
    ("Kim Yerim",      "chr-yeri",          "yeri.jpg"),
    ...
    ("Bieber",        "chr-justin-bieber", "justin-bieber.jpg"),
    ("Emma Stone",     "chr-emma-stone",    "emma-stone.jpg"),
    ("Damien Chazelle","chr-damien-chazelle","damien-chazelle.jpg"),
    # CAUTION: bare "Emma" matches inside "Emma Watson" — if a future chapter
    ...
    ("Kim Eun-sook",   "chr-kim-eunsook",   "kim-eunsook.jpg"),
    ("Choi Na-young",  "chr-choi-nayoung",  "choi-nayoung.jpg"),
    ("Na-young",       "chr-choi-nayoung",  "choi-nayoung.jpg"),
    ("Park Bo-gum",    "chr-park-bogum",    "park-bogum.jpg"),
    ("Bo-gum",         "chr-park-bogum",    "park-bogum.jpg"),
    ...
    ("Park Ji-hoon",  "chr-park-jihun",    "park-jihun.jpg"),
    ("Ji-hoon",       "chr-park-jihun",    "park-jihun.jpg"),
