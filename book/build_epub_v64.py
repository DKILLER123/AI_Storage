"""Build the Version 64 EPUB (chapters 239-240 added: a corporate meal account at the auntie restaurant, an invitation delivered properly at a red light, a chart crown changing hands twice in two weeks, one line of orientation clarification that broke the internet, and a summer hiring season closed by a single suggestion under a collab cap) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_64.epub"
