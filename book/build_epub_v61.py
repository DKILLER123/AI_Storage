"""Build the Version 61 EPUB (chapters 233-234 added: a lipstick launch that sold out twice in ninety seconds, an ad premiere on the office monitor, a Minions chorus license, a three-million-dollar Riot term sheet, one legends-never-fall idea born between Faker and Kobe, and a teaser watched through a van window) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_61.epub"
