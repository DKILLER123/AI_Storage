"""Build the Version 66 EPUB (chapters 243-244 added: one screen maps three rules of love, the recording studio does not believe in pink; plus the Alan Walker character-intro card and the ch241/242 translation repairs) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_66.epub"
