#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 25 EPUB (chapters 163-164 added: the Blue Dragon night - Chanel-red-carpet cold shoulder, Jeong-hun Best Director, Chun Woo-hee's upset, Jin-ri accepting Si-on's Best Actor with four lines plus improv, The Attorney's Daesang, the trophy carried to Jamsil in the gown; and concert day - Kim Min-jun's vlogger entry POV, the coat worn to be invisible, meeting Professor Yoon from the next seat, the tvN countdown and the door-sync 'Legend' opening) plus three new wardrobe images; from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_25.epub"
