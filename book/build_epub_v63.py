"""Build the Version 63 EPUB (chapters 237-238 added: two boxes of chocolate buying half an hour that became eight, the Lennon guitar converted into a twenty-six-song production debt, the first Legends Never Die vocal, one page of lyrics written under a borrowed name, a phone flicked and dropped for the sake of a scene, and a radio sunbae who confirmed a relationship nobody announced) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_63.epub"
