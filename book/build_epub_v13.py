#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 13 EPUB (ch139 chat-name self-row fix; ch140 live-stage broadcast block plus live-comments thread for the Silver Crown medal presentation; ch57 whole-call three-block wrap) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_13.epub"
