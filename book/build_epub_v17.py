#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 17 EPUB (chapters 147-148 added: saffron morning and the AMAs aftermath - the vinegar, the burn-account likes, Little Apple, the decline; Scooter's apple-bite send-off, the Love Yourself teaser gambit, the chart flood, and two women watching from Seoul) plus five generated wardrobe images embedded in wd-photo blocks; from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_17.epub"
