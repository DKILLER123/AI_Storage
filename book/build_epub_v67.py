"""Build the Version 67 EPUB (chapters 245-246 added: Producer Lee advances step by step, and Sado opens to a smash; plus the user-provided Ariana Grande and Alan Walker character-intro portraits) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_67.epub"
