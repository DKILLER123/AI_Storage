"""Build the Version 65 EPUB (chapters 241-242 added: an email sent to a Norwegian bedroom producer, ten thousand dollars wired as respect, one rank permanently hidden from an idol, a midnight snack delivery renewed a girlfriend contract, and a guest list that put three heartbreaks on one page) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_65.epub"
