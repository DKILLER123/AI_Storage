#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 23 EPUB (chapters 153-154 added: the million-admissions wrap party for Green Bottle Fly, the mother-investor reveal, the Orange Juice toast and the Blue House pitch disguised as small talk; Hong Kong - the incognito corridor merger, the earbud demo of Way Back Home, the secret-arrangement-studies deal, and the MAMA opening that opened a door) plus ch152 revisions: varied news sources (Billboard/Rolling Stone/Pitchfork/Variety) and the Eun-ah KakaoTalk converted to a full chat-container through the going-on-set line; two new wardrobe images; from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_23.epub"
