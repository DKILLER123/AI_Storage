#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 14 EPUB (chapters 141-142 added: KB crisis-room, Insight bait headline, Silver Crown Crown Prince chats, Nov 9 trending/market-open broadcast; Hyundai duty-free pledge + AMAs choreo draft) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_14.epub"
