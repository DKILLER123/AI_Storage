"""Build the Version 68 EPUB (chapters 247-248 added: the pretty noona buying dinner, and the same four-leaf clover with different hearts; plus the ch78 KakaoTalk chat-block repair) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_68.epub"
