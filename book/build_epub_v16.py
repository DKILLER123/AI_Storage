#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 16 EPUB (chapters 145-146 added: AMAs day - the couture truce and mix-and-match look, the Equus motorcade, the red carpet with Ariana, Big Sean's hallway pitch, Blank Space opener, the KING enthronement stage, two trophies and two speeches, Selena's pocket square, the Dick Clark Award, and the cheek kiss) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_16.epub"
