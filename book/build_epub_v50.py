"""Build the Version 50 EPUB (chapters 211-212 added: a jacket laid across bare legs by the Haeundae night wind, an hour of ten-minute ledgers, a booked-out hall where the credits got the only full attention, two cars parting at an intersection, a silenced alarm repaid at forty minutes of interest, three unused apology drafts, a makeup chair that recalibrated a whole set, one word answer to Hollywood and one meeting requested) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_50.epub"
