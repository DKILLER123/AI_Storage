#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 6 EPUB (ch128-132 new chapters + lyric/screen-view/anchor fixes (V6)) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "/home/user/Seoul_Starting_With_Debt_Collection__Version_6.epub"
