#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 18 EPUB (chapters 149-150 added: the Incheon dawn landing and the Apple Killer\'s placed bet, the Seoul Plaza decline, Park So-dam and the chance-engine; the night-rain palace incursion and the pulled kick, the guest-vote chiveshed, and two one-a.m. phone calls - the fire hydrant and the strategic buffer) plus two new generated wardrobe images; chat-name received-row fixes in ch147-148; from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_18.epub"
