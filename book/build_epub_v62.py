"""Build the Version 62 EPUB (chapters 235-236 added: a pop-up counter emptied to its tester sticks, four bonus envelopes and one sugar-cream cake, the wrap of The Three Evils pulled three weeks early, a demo built in three versions, and a paper bag of chocolate deployed against one bad studio mood) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_62.epub"
