"""Build the Version 58 EPUB (chapters 227-228 added: one boiled pigs head wearing red envelopes, a press day that died in every role, a pre-written headline slot machine, one agent who discovered that goodwill generates cash flow, a support truck signed IU, a cigarette that refused to light, a vice chairman who came in person, a hanok lunch where one zero was quietly appended, and a gloss launch that now runs from Seoul to Times Square) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_58.epub"
