#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 12 EPUB (ch139/140: the court-robes awards arrival & the President's Silver Crown presentation; ch137 phone-screen billboard + played voice-message block per review; bookwide display-row anchor cleanup ch126/129) from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_12.epub"
