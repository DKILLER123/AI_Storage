#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Build the Version 19 EPUB (chapters 151-152 added: the 1:59 a.m. delegation, the SM ultimatum email, the supermarket gig and the shoujo-manga opening - with Sulli-sunbaenim revealed as the recommender; the rice chest wrapped, Jamsil locked for December 18, the broadcasters outbid, the subway extended, the industry ground flat, and MAMA answered with the opening slot) plus the Taylor Swift character card (new book portrait, first-appearance cards/modals parity 70/70) and the Red Velvet group wardrobe image; chat fixes retained; from epub_src (mimetype stored first)."""
import os, zipfile, time

SRC = "/home/user/work/epub_src"
OUT = "Seoul_Starting_With_Debt_Collection__Version_19.epub"
